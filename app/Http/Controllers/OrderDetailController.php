    ...
    public function updateStatus(string $id) {
        ...
        if ($orderdetail) {
            if ($orderdetail->is_payed == 0) {
                ...
                $order = Order::leftJoin('customers','customers.id','=','orders.customer_id')->where('orders.id', $detail)->first();
                $set = Setting::find(46);
                ...
                return redirect()->route('order.view', $orderdetail->id)->with(['success' => 'Tagihan sudah lunas !']);
