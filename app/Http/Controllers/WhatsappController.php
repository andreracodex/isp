    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()){
            ...
            ->addColumn('action', function (Wa $wa) {
                return "
                <a href=". route('wa.link', $wa->id) ." data-pc-animate='blur' data-bs-toggle='modal' data-bs-target='#qrModal' class='btn btn-sm btn-success d-inline-flex' type='button' data-container='body' data-bs-toggle='tooltip' data-bs-placement='top' title='Linked Device'><i class='fa fa-link'>&nbsp;</i></a>
