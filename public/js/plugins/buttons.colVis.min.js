    ...
    return (
        ...
        n.extend(t.ext.buttons, {
            colvis: function (n, t) {
                return {
                    ...
                    text: function (n) {
                        return n.i18n(
                            "buttons.colvis",
                            '<i class="fa fa-eye"></i> Hide/Show'
                        );
                    },
                    className: "buttons-colvis btn btn-sm btn-rounded btn-primary",
                    buttons: [
                        {
            ...
            columnVisibility: {
                ...
                action: function (n, t, e, i) {
                    (n = t.columns(i.columns)),
                        (t = n.visible()),
                        n.visible(
                            i.visibility !== o
                                ? i.visibility
                ...
                init: function (n, t, e) {
                    ...
                    t.attr("data-cv-idx", e.columns),
                        n
                            .on(
                                "column-visibility.dt" + e.namespace,
                                function (t, i) {
                                    !i.bDestroying &&
                                        i.nTable == n.settings()[0].nTable &&
                                        o.active(n.column(e.columns).visible());
                                }
                            )
                            .on("column-reorder.dt" + e.namespace, function () {
                                1 === n.columns(e.columns).count() &&
