...
<body class="landing-page">
    ...
    <div class="container" style="margin-top: 100px;">
        ...
        <p>Kami ingin mengucapkan terima kasih atas kepercayaan Anda menggunakan layanan internet kami.</p>
        <p>Semoga layanan yang kami berikan dapat memenuhi kebutuhan Anda dengan baik,
            Terima kasih atas dukungan dan kesetiaan Anda sebagai pelanggan kami.</p>

        <h5><a href="{{ route('frontend') }}">Back To Home</a></h5>
