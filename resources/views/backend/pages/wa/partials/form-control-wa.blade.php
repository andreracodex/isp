        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="device_name" class="form-control" placeholder="Device Name" aria-label="device_name" required aria-describedby="basic-addon1">
                </div>
                <label for="device">Phone Number Register</label>
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1"><i class="fab fa-whatsapp"></i></span>
                    <input type="number" name="device_number" min="0" class="form-control" placeholder="Device Name" aria-label="device_number" required aria-describedby="basic-addon1">
                </div>
            </div>
