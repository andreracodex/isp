...
@section('title', 'Inventory Satuan Data')
...
@push('script')
    ...
    <script type="text/javascript">
        $(function() {
            ...
            let table = $('#satuan').DataTable({
                dom: "<'row'<'col-sm-12 col-md-6'Bl><'col-sm-12 col-md-6'f>><'row'<'col-sm-12'tr>><'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>",
                deferRender: true,
                processing: true,
                serverSide: true,
                responsive: true,
                ajax: "{{ route('invesatuan.index') }}",
                buttons: [
                    'colvis',
                    {
                        extend: 'print',
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#satuan').on('click', '.hapusSatuan', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            method: 'GET',
                            url: "{{ route('invesatuan.delete', ':id') }}".replace(
                                ':id', idItem),
                            data: {
                                _token: '{{ csrf_token() }}',
                                id: idItem,
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="dt-responsive table-responsive">
                        <table id="satuan" class="table compact table-striped table-hover table-bordered wrap"
                            style="width:100%">
                            <thead>
                                <tr>
