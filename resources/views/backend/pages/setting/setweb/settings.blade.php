    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('websetting.create') }}" method="POST" class="needs-validation" novalidate="">
                    @csrf
                    @include('layouts.backend.pages.setting.setweb.partials.form-control-settings', ['submit' => 'Create'])
                    </form>
                </div>
            </div>
        </div>
