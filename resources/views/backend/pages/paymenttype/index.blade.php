...
@section('title', 'Payment Type Data')
...
@push('script')
    ...
    <script type="text/javascript">
        $(function() {
            ...
            let table = $('#paymenttype').DataTable({
                dom: "<'row'<'col-sm-12 col-md-6'Bl><'col-sm-12 col-md-6'f>><'row'<'col-sm-12'tr>><'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>",
                deferRender: true,
                processing: true,
                serverSide: true,
                responsive: true,
                ajax: "{{ route('paymenttype.index') }}",
                buttons: [
                    'colvis',
                    {
                        extend: 'print',
                ...
                columns: [{
                    ...
                    {
                        data: 'payment_methode_name',
                        name: 'payment_methode_name'
                    },
                    {
                        data: 'is_active',
                        name: 'is_active',
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#paymenttype').on('click', '.hapusPaymentType', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            method: 'GET',
                            url: "{{ route('paymenttype.delete', ':id') }}".replace(
                                ':id', idItem),
                            data: {
                                _token: '{{ csrf_token() }}',
                                id: idItem,
                            ...
                            error: function(error) {
                                Swal.fire('Error', 'Gagal menghapus metode pembayaran',
                                    'error');
                                // Handle error
                            }
                        });
            ...
            <div class="card">
                <div class="card-header">
                    <div class="headerbutton">
                        <div>
                            <a href="{{ route('paymenttype.create') }}" type="button"
                ...
                <div class="card-body">
                    <div class="dt-responsive table-responsive">
                        <table id="paymenttype" class="table compact table-striped table-hover table-bordered wrap"
                            style="width:100%">
                            <thead>
                                <tr>
