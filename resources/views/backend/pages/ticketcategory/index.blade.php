...
@section('title', 'Ticket Category Data')
            ...
            $('#kateticket').on('click', '.hapusKateticket', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            method: 'GET',
                            url: "{{ route('ticketcat.delete', ':id') }}".replace(
                                ':id', idItem),
                            data: {
                                _token: '{{ csrf_token() }}',
                                id: idItem,
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h2 class="mb-0">Kategori Ticket</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="headerbutton">
                        <div>
                            <a href="{{ route('ticketcat.create') }}" type="button"
                                class="btn btn-sm btn-outline-primary d-inline-flex"><i class="ti ti-plus me-1"></i>
                                Kategori Ticket</a>
                        </div>
                        <div>
                            <a href="{{ route('pdf.ticketcat') }}" type="button"
