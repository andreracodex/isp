    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('#article').DataTable({
                ...
                autoWidth: true,
                scrollX: true,
                ajax: "{{ route('productarticle.index') }}",
                buttons: [{
                        extend: 'copyHtml5',
                ...
                columns: [{
                    ...
                    {
                        data: 'kode_spon_plong',
                        name: 'kode_spon_plong'
                    },
                    {
                        data: 'nama_artikel',
                        name: 'nama_artikel'
    ...
    <div class="card bg-light-info shadow-none position-relative overflow-hidden">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Product Article</h4>
                    {{ Breadcrumbs::render() }}
                </div>
                <div class="col-3">
    ...
    @can('add article')
        <div class="card">
            <div class="card-header">
                <h5>Create New Product Article</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('productarticle.create') }}" enctype="multipart/form-data" method="POST"
                    class="needs-validation" novalidate="">
                    @csrf
                    @include('layouts.backend.pages.artikel.partials.form-control-artikel', [
                        'submit' => 'Create',
                    ])
                </form>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="article" style="width:100%"
