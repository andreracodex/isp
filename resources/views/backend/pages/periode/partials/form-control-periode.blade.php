<div class="row">
    <div class="col-md-9 mb-3">
        <label class="form-label" for="nama">Periode</label>
        <input class="form-control" type="date" name="bulan_periode"
            value="{{ old('bulan_periode') ?? \Carbon\Carbon::parse($periode->bulan_periode)->format('Y-m-d') }}"
    ...
    <div class="col-md-3 mb-3">
        <label class="form-label" for="is_active">Status Periode</label>
        <div class="form-check form-switch custom-switch-v1">
            <input type="checkbox" class="form-check-input input-success @error('is_active') is-invalid @enderror"
                ...
                @if ($periode->is_active == 1) @checked(true) @else @checked(false) @endif>
