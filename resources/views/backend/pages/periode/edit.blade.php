...
@section('title', 'Periode Tagihan Edit')
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h2 class="mb-0">Edit Periode Tagihan</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Edit Periode Tagihan</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('periode.update', $periode->id) }}" enctype="multipart/form-data" method="POST"
